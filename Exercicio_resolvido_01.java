...
public class Exercicio_resolvido_01 {
	...
	public static void main(String[] args) {
		...
		//Exercício proposto com: entrada de dados + processamento de dados + saída de dados 
		...
		//Exemplo saída: area (largura x comprimento) = 300.00 preco (area x metro quadrado) = 60000.00
